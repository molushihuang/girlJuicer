...
public class GirlListViewActivity extends BaseActivity implements GirlShowAdapter.ItemListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_girl_listview;
    }
...
//                String subData = JSONUtils.getString(data, "list", "");
    ...
    public void onItemClick(GirlBean item) {
        jump2Activity(DrawerActivity.class);
    }
    ...
    public void onItemLongClick(final GirlBean item) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int checkCallPhonePermission = ContextCompat.checkSelfPermission(GirlListViewActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                if (Build.VERSION.SDK_INT >= 23 && checkCallPhonePermission != PackageManager.PERMISSION_GRANTED) {
                    ...
                    savUrl = item.getUrl();
                    ActivityCompat.requestPermissions(GirlListViewActivity.this, mPermissionList, 123);
    ...
    public void save(String url) {
        new PictureUtils.SaveImageTask(GirlListViewActivity.this).execute(url);
