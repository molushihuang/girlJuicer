 ...
 */
package com.anthole.quickdev.adapter;
...
import com.anthole.quickdev.http.base.BaseRequest;
		...
		BaseQuickAdapter<T, BaseAdapterHelper>
{
    ...
    protected void showLoadingDialog(RequestHandle requestHandle){
    	if(context instanceof QFragmentActivity){
    		((QFragmentActivity)context).showLoadingDialog(requestHandle);
    	}
    }
    
    protected void dismissLoadingDialog(){
    	if(context instanceof QFragmentActivity){
    		((QFragmentActivity)context).dismissLoadingDialog();
    	}
    }
}
