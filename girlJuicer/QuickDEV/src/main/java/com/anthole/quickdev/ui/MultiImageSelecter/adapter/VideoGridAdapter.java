...
public class VideoGridAdapter extends BaseAdapter {
    ...
    public VideoGridAdapter(Context context, boolean showCamera){
        mContext = context;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(type == TYPE_CAMERA){
            view = mInflater.inflate(R.layout.list_item_camera_video, viewGroup, false);
            view.setTag(null);
    ...
    class ViewHolde {
        ...
        ViewHolde(View view){
            ...
            duration=(TextView)view.findViewById(R.id.tv_video_duration);
        ...
        void bindData(final Image data){
            ...
            duration.setText(TimeUtils.getVideoDuration(data.getDuration()));
            // 处理单选和多选状态
