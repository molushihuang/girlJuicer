...
public class WanViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return The WanViewHolder for chaining.
     */
    public WanViewHolder setOnClickListener(int viewId, View.OnClickListener listener) {
        View view = getView(viewId);
     ...
     * @return The WanViewHolder for chaining.
     */
    public WanViewHolder setOnTouchListener(int viewId, View.OnTouchListener listener) {
        View view = getView(viewId);
     ...
     * @return The WanViewHolder for chaining.
     */
    public WanViewHolder setOnLongClickListener(int viewId, View.OnLongClickListener listener) {
        View view = getView(viewId);
